...
PHYSICAL_RESOURCE_ID_SPECIAL_CASES = {
    ...
    "AWS::ApiGatewayV2::ApiMapping": "/properties/ApiMappingId",
    "AWS::ApiGatewayV2::Deployment": "/properties/DeploymentId",
    "AWS::ApiGatewayV2::Integration": "/properties/IntegrationId",
    ...
    "AWS::Cognito::UserPoolReplica": "</properties/UserPoolId>|</properties/RegionName>",
    "AWS::Cognito::UserPoolRegionalConfigurationAttachment": "/properties/UserPoolId",
    "AWS::Cognito::ManagedLoginBranding": "/properties/ManagedLoginBrandingId",
    "AWS::Cognito::Terms": "/properties/TermsId",
    "AWS::Cognito::UserPoolGroup": "/properties/GroupName",
    "AWS::Cognito::UserPoolIdentityProvider": "/properties/ProviderName",
    "AWS::Cognito::UserPoolResourceServer": "/properties/Identifier",
    "AWS::Cognito::UserPoolRiskConfigurationAttachment": "UserPoolRiskConfigurationAttachment-</properties/UserPoolId>-</properties/ClientId>",
    "AWS::Cognito::UserPoolUICustomizationAttachment": "UserPoolUICustomizationAttachment-</properties/UserPoolId>-</properties/ClientId>",
    "AWS::Cognito::UserPoolUser": "/properties/Username",
    "AWS::Cognito::UserPoolUserToGroupAttachment": "/properties/Id",
